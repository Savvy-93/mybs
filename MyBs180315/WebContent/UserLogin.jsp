...
<script type="text/javascript" src="myassets/myjs/login.js"></script>
</head>
<body>
	<div class="am-g myapp-login">
		<div class="myapp-login-logo-block  tpl-login-max">
			<div class="myapp-login-logo-text">
				<div class="myapp-login-logo-text">
					学生支出管理系统<span> Login</span> <i class="am-icon-skyatlas"></i>
			...
			<div class="am-u-sm-10 login-am-center">
				<form class="am-form" action="user/loginAction!login" method="post" onsubmit="return checkUserForm()">
					<div class="form-back">
						<!-- 中间的表单 -->
						...
						<p>
							<input type="submit" id="login-input-submit-button" value="登录" />
